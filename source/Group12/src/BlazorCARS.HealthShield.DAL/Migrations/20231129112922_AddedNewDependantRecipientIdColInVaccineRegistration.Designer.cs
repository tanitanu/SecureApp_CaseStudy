...
namespace BlazorCARS.HealthShield.DAL.Migrations
{
    ...
    [Migration("20231129112922_AddedNewDependantRecipientIdColInVaccineRegistration")]
    partial class AddedNewDependantRecipientIdColInVaccineRegistration
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BlazorCARS.HealthShield.DAL.Entity.Recipient", b =>
                {
                    ...
                    b.Property<int?>("DependentRecipientId")
                        .HasColumnType("int")
                        .HasColumnOrder(18);
            ...
            modelBuilder.Entity("BlazorCARS.HealthShield.DAL.Entity.VaccineRegistration", b =>
                {
                    ...
                    b.Property<int>("DependantRecipientId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(1)
                        .HasColumnOrder(12);
