...
namespace DiscussionForumUserInterface.Pages.User
{
    ...
    /// This is discussion page for user where user can see discussion, post discussion answer, delete, like and dislike discussion .
    /// </summary>
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (response.StatusCode == HttpStatusCode.OK)
                    {
                        ...
                        QuestionAnswerDetails.LoginId = Request.Cookies["Id"].ToString();
                        return Page();
